...
public class ListnerImpClass extends BaseClassforScm implements ITestListener, ISuiteListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		TakesScreenshot ts = (TakesScreenshot)BaseClassforScm.sdriver;
